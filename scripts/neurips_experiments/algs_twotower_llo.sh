#!/bin/bash
# run set-c of algs with the leave-last-out dataset splits (llo)
...
source /home/saiprasad/reczilla/scripts/utils.sh
source /home/saiprasad/reczilla/scripts/neurips_experiments/v5_dataset_list.sh
...
do
  ...
  do
    ...
    gsutil cp "${split_path_on_bucket}/*" /home/saiprasad/split/
    ...
    cd /home/saiprasad/reczilla/RecSys2019_DeepLearning_Evaluation
    python -m Experiment_handler.run_experiment $arg_str #>> ${LOG_FILE} 2>&1 &
