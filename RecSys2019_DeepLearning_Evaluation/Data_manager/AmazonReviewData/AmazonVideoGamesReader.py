...
class AmazonVideoGamesReader(_AmazonReviewDataReader):

    DATASET_URL_RATING = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Video_Games.csv"
    DATASET_URL_METADATA = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_Video_Games.json.gz"

    DATASET_SUBFOLDER = "AmazonReviewData/AmazonVideoGames/"
    ...
    def _load_from_original_file(self):
        ...
        URM_path = self._get_URM_review_path(data_folder = dataset_split_folder,
                                            file_name = "ratings_Video_Games.csv",
