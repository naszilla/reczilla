...
class AmazonLuxuryBeautyReader(_AmazonReviewDataReader):

    DATASET_URL_RATING = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Luxury_Beauty.csv"
    DATASET_URL_METADATA = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_Luxury_Beauty.json.gz"

    DATASET_SUBFOLDER = "AmazonReviewData/AmazonLuxuryBeauty/"
    ...
    def _load_from_original_file(self):
        ...
        metadata_path = self._get_ICM_metadata_path(data_folder = dataset_split_folder,
                                                    compressed_file_name = "meta_Luxury_Beauty.json.gz",
                                                    decompressed_file_name = "meta_Luxury_Beauty.json",
                                                    file_url = self.DATASET_URL_METADATA)


        URM_path = self._get_URM_review_path(data_folder = dataset_split_folder,
                                            file_name = "ratings_Luxury_Beauty.csv",
