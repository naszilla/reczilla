...
class AmazonPatioLawnGardenReader(_AmazonReviewDataReader):

    DATASET_URL_RATING = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Patio_Lawn_and_Garden.csv"
    DATASET_URL_METADATA = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_Patio_Lawn_and_Garden.json.gz"

    DATASET_SUBFOLDER = "AmazonReviewData/AmazonPatioLawnGarden/"
    ...
    def _load_from_original_file(self):
        ...
        metadata_path = self._get_ICM_metadata_path(data_folder = dataset_split_folder,
                                                    compressed_file_name = "meta_Patio_Lawn_and_Garden.json.gz",
                                                    decompressed_file_name = "meta_Patio_Lawn_and_Garden.json",
