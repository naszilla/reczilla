...
class AmazonCarElectronicsReader(_AmazonReviewDataReader):

    DATASET_URL_RATING = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Car_Electronics.csv"
    DATASET_URL_METADATA = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_Car_Electronics.json.gz"

    DATASET_SUBFOLDER = "AmazonReviewData/AmazonCarElectronics/"
    ...
    def _load_from_original_file(self):
        ...
        metadata_path = self._get_ICM_metadata_path(data_folder = dataset_split_folder,
                                                    compressed_file_name = "meta_Car_Electronics.json.gz",
                                                    decompressed_file_name = "meta_Car_Electronics.json",
                                                    file_url = self.DATASET_URL_METADATA)


        URM_path = self._get_URM_review_path(data_folder = dataset_split_folder,
                                            file_name = "ratings_Car_Electronics.csv",
