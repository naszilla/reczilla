...
class AmazonPopReader(_AmazonReviewDataReader):

    DATASET_URL_RATING = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Pop.csv"
    DATASET_URL_METADATA = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_Pop.json.gz"

    DATASET_SUBFOLDER = "AmazonReviewData/AmazonPop/"
