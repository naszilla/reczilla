...
class AmazonSportsOutdoorsReader(_AmazonReviewDataReader):

    DATASET_URL_RATING = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_Sports_and_Outdoors.csv"
    DATASET_URL_METADATA = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_Sports_and_Outdoors.json.gz"

    DATASET_SUBFOLDER = "AmazonReviewData/AmazonSportsOutdoors/"
    ...
    def _load_from_original_file(self):
        ...
        metadata_path = self._get_ICM_metadata_path(data_folder = dataset_split_folder,
                                                    compressed_file_name = "meta_Sports_and_Outdoors.json.gz",
                                                    decompressed_file_name = "meta_Sports_and_Outdoors.json",
