...
class AmazonCDsVinylReader(_AmazonReviewDataReader):

    DATASET_URL_RATING = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/ratings_CDs_and_Vinyl.csv"
    DATASET_URL_METADATA = "http://snap.stanford.edu/data/amazon/productGraph/categoryFiles/meta_CDs_and_Vinyl.json.gz"

    DATASET_SUBFOLDER = "AmazonReviewData/AmazonCDsVinyl/"
    ...
    def _load_from_original_file(self):
        ...
        metadata_path = self._get_ICM_metadata_path(data_folder = dataset_split_folder,
                                                    compressed_file_name = "meta_CDs_and_Vinyl.json.gz",
                                                    decompressed_file_name = "meta_CDs_and_Vinyl.json",
