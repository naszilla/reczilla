...
class MarketBiasAmazonReader(DataReader):

    DATASET_URL = "https://raw.githubusercontent.com/MengtingWan/marketBias/master/data/df_electronics.csv"
    DATASET_SUBFOLDER = "MarketBiasAmazon/"
    AVAILABLE_ICM = []
